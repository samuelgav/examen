            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="${contextRoot}/home"><i class="fa fa-dashboard fa-fw"></i> Inicio</a>
                        </li>
                        ...
                        <li>
                            <a href="${contextRoot}/show/all/tipopersona"><i class="fa fa-dashboard fa-fw"></i> Tipo Personas</a>
                        </li>
